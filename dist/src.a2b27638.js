...
exports.checkPayload = exports.filterData = exports.makeRequest = exports.API_URL = void 0;
// api end point
var API_URL = "https://api.spacexdata.com/v3/launches/past";
exports.API_URL = API_URL;
var LAUNCH_YEAR = "2018"; // generic function to get the api result
...
var filterData = function filterData(data) {
  ...
  if (data && data.length > 0) {
    filteredData = data.reduce(function (acc, item) {
      var launch_year = item.launch_year,
          rocket = item.rocket,
          flight_number = item.flight_number,
          mission_name = item.mission_name,
          launch_date_utc = item.launch_date_utc; // get the payload

      var payloads = rocket.second_stage.payloads;
  ...
  var finalData = removeDate(sortedData);
  return finalData;
...
var checkPayload = function checkPayload(payloads) {
...
var removeDate = function removeDate(data) {
...
},{}],"src/solution.js":[function(require,module,exports) {
"use strict";

var _utils = require("./utils");

var prepare = function prepare(data) {
  var filteredData = (0, _utils.filterData)(data);
  return filteredData;
};
...
var output = function output(data) {
  ...
  try {
    for (var _iterator = data[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      i++;
      outputText.push(" {");
      var keys = Object.keys(item).length;
      var j = 0;
      ...
      for (var property in item) {
        ...
        if (j < keys) {
          if (typeof value === "string") {
            outputText.push("   \"".concat(key, "\": \"").concat(value, "\","));
          } else {
            outputText.push("   \"".concat(key, "\": ").concat(value, ","));
          }
        } else {
...
(0, _utils.makeRequest)(_utils.API_URL).then(function (item) {
  (0, _solution.renderData)((0, _solution.prepareData)(JSON.parse(item.response)));
}).catch(function (error) {
  console.log("Something went wrong", error);
});
},{"./solution":"src/solution.js","./utils":"src/utils.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
